...
```hcl
github.com/pbs/terraform-aws-lambda-api-module?ref=0.6.36
```
...
```hcl
module "api" {
  source = "github.com/pbs/terraform-aws-lambda-api-module?ref=0.6.36"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lambda"></a> [lambda](#module\_lambda) | github.com/pbs/terraform-aws-lambda-module | 1.3.31 |
