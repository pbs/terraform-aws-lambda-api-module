...
```hcl
github.com/pbs/terraform-aws-lambda-api-module?ref=0.5.0
```
...
```hcl
module "api" {
  source = "github.com/pbs/terraform-aws-lambda-api-module?ref=0.5.0"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lambda"></a> [lambda](#module\_lambda) | github.com/pbs/terraform-aws-lambda-module | 1.3.0 |
